#!/usr/bin/env python3
"""
Raspberry Pi Network Cable Tester - Auto-Detection Version
...
This version includes automatic interface detection and USB adapter change detection.
For a simpler version with static configuration, see network_cable_tester.py
"""
...
class NetworkCableTester:
    ...
    def print_welcome_header(self):
        ...
        print("\n" + "="*60)
        print("RASPBERRY PI NETWORK CABLE TESTER (AUTO-DETECTION)")
        print("="*60)
